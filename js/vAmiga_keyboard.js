...
function installKeyboard(layout=true) {
    ...
    [{k:'CTRL',c:'ControlLeft',cls:'ControlLeft',s:2},{k:'CAPS</br>LOCK', c:'CapsLock',cls:'capslock',s:2},{k:'A'},{k:'S'},{k:'D'},{k:'F'},{k:'G'},{k:'H'},{k:'J'},{k:'K'},{k:'L'},{k:';', sk:':', c:'Semicolon'},{k:',', sk:'\"', c:'Quote'},{k:'#', sk:'^', c:'hashtag'}, {k:'',c:'EnterExt2',c_use:'Enter',g:4,s:2, mapto:['Enter','EnterExt']},{g:7},{k:'1',c:'Numpad1'},{k:'2',c:'Numpad2'},{k:'3',c:'Numpad3'}], 
...
draggable="false">
    ...
    // Render the hide keyboard button separately (only shown when keyboard is hidden)
    let hide_keydef = {g:6, k:'hide', c:'hide_keyboard_fixed', cls:'darkkey', s:3};
    let hide_button_html = '';
    let pos_label = '';
    let label = hide_keydef.k;
    if (label == "hide") {
        label = `<svg xmlns="http://www.w3.org/2000/svg" width="2.0em" height="2.0em" fill="currentColor" class="bi bi-pause-btn" viewBox="0 0 16 16"><path d="M14 5a1 1 0 0 1 1 1v5a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1h12zM2 4a2 2 0 0 0-2 2v5a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2H2z"/><path d="M13 10.25a.25.25 0 0 1 .25-.25h.5a.25.25 0 0 1 .25.25v.5a.25.25 0 0 1-.25.25h-.5a.25.25 0 0 1-.25-.25v-.5zm0-2a.25.25 0 0 1 .25-.25h.5a.25.25 0 0 1 .25.25v.5a.25.25 0 0 1-.25.25h-.5a.25.25 0 0 1-.25-.25v-.5zm-5 0A.25.25 0 0 1 8.25 8h.5a.25.25 0 0 1 .25.25v.5a.25.25 0 0 1-.25.25h-.5A.25.25 0 0 1 8 8.75v-.5zm2 0a.25.25 0 0 1 .25-.25h1.5a.25.25 0 0 1 .25.25v.5a.25.25 0 0 1-.25.25h-1.5a.25.25 0 0 1-.25-.25v-.5zm1 2a.25.25 0 0 1 .25-.25h.5a.25.25 0 0 1 .25.25v.5a.25.25 0 0 1-.25.25h-.5a.25.25 0 0 1-.25-.25v-.5zm-5-2A.25.25 0 0 1 6.25 8h.5a.25.25 0 0 1 .25.25v.5a.25.25 0 0 1-.25.25h-.5A.25.25 0 0 1 6 8.75v-.5zm-2 0A.25.25 0 0 1 4.25 8h.5a.25.25 0 0 1 .25.25v.5a.25.25 0 0 1-.25.25h-.5A.25.25 0 0 1 4 8.75v-.5zm-2 0A.25.25 0 0 1 2.25 8h.5a.25.25 0 0 1 .25.25v.5a.25.25 0 0 1-.25.25h-.5A.25.25 0 0 1 2 8.75v-.5zm11-2a.25.25 0 0 1 .25-.25h.5a.25.25 0 0 1 .25.25v.5a.25.25 0 0 1-.25.25h-.5a.25.25 0 0 1-.25-.25v-.5zm-2 0a.25.25 0 0 1 .25-.25h.5a.25.25 0 0 1 .25.25v.5a.25.25 0 0 1-.25.25h-.5a.25.25 0 0 1-.25-.25v-.5zm-2 0A.25.25 0 0 1 9.25 6h.5a.25.25 0 0 1 .25.25v.5a.25.25 0 0 1-.25.25h-.5A.25.25 0 0 1 9 6.75v-.5zm-2 0A.25.25 0 0 1 7.25 6h.5a.25.25 0 0 1 .25.25v.5a.25.25 0 0 1-.25.25h-.5A.25.25 0 0 1 7 6.75v-.5zm-2 0A.25.25 0 0 1 5.25 6h.5a.25.25 0 0 1 .25.25v.5a.25.25 0 0 1-.25.25h-.5A.25.25 0 0 1 5 6.75v-.5zm-3 0A.25.25 0 0 1 2.25 6h1.5a.25.25 0 0 1 .25.25v.5a.25.25 0 0 1-.25.25h-1.5A.25.25 0 0 1 2 6.75v-.5zm0 4a.25.25 0 0 1 .25-.25h.5a.25.25 0 0 1 .25.25v.5a.25.25 0 0 1-.25.25h-.5a.25.25 0 0 1-.25-.25v-.5zm2 0a.25.25 0 0 1 .25-.25h5.5a.25.25 0 0 1 .25.25v.5a.25.25 0 0 1-.25.25h-5.5a.25.25 0 0 1-.25-.25v-.5z"/></svg>`;
    }
    let cls = hide_keydef.cls || '';
    let css = `keycap_base ${cls}`;
    let style = hide_keydef.style || null;
    let gap = hide_keydef.g || 4;
    css += ` g-${gap}`;
    hide_button_html += `<div id="button_hide_keyboard_fixed" class="${css}"`;
    if (style != null) hide_button_html += ` style="${style}"`;
    hide_button_html += `>${pos_label}${label}</div>`;
    $('#hide_keyboard_container').html(hide_button_html);

    // start hidden; show only after user has opened the keyboard once
    $('#hide_keyboard_container').css({display: 'none'});

    let storedKeyboardTop = null;
    const toggleVirtualKeyboard = () => {
        if ($('#virtual_keyboard').hasClass('show')) {
    ...
    // Add event listener for fixed hide keyboard button (visible only when keyboard hidden)
    let hide_element_fixed = document.getElementById("button_hide_keyboard_fixed");
    hide_element_fixed.addEventListener('mousedown', function(event) {
    ...
    hide_element_fixed.addEventListener('touchstart', function(event) {
    ...
    // keep the fixed button positioned where the grid hide-button sits
    // (we capture its position while the keyboard is visible)
    let storedHideButtonRect = null;
    let keyboardWasShownOnce = false;

    $('#virtual_keyboard').on('shown.bs.collapse', function () {
        const gridHideButton = document.getElementById('button_hide_keyboard');
        if (gridHideButton) {
            storedHideButtonRect = gridHideButton.getBoundingClientRect();
        }
        keyboardWasShownOnce = true;
        $('#hide_keyboard_container').css({display: 'none'});
    });

    $('#virtual_keyboard').on('hidden.bs.collapse', function () {
        if (!keyboardWasShownOnce) {
            // Don't show fixed button until keyboard has been shown at least once
            return;
        }
        if (storedHideButtonRect) {
            $('#hide_keyboard_container').css({
                display: 'block',
                top: storedHideButtonRect.top + 'px',
                left: storedHideButtonRect.left + 'px',
                bottom: 'auto'
            });
        } else {
            // Fallback: place at bottom-right
            $('#hide_keyboard_container').css({display: 'block', bottom: '0', top: 'auto'});
        }
    });
