...
const core_version  = '4.3.5'; //has to be the same as the version in Emulator/config.h and vAmiga_browser.js
const ui_version = '2026_08_03'+url_root_path.replace("/","_"); 
