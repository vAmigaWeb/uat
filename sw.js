...
const core_version  = '4.1.1'; //has to be the same as the version in Emulator/config.h and vAmiga_browser.js
const ui_version = '2025_05_17'+url_root_path.replace("/","_"); 
